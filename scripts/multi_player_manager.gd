...
#var multiplayer_scene = preload("res://scenes/multi_player_manager.tscn")
var multiplayer_scene = preload("res://scenes/knight.tscn")
...
#	print("Remove single player")
	#var player_to_remove = get_tree().get_current_scene().get_node("Players")
	#if player_to_remove:
